...
class UserControllerTest extends WebTestCase
    ...
    // Vérifie qu'un administrateur peut accéder à la gestion des utilisateurs
    // public function testAdminCanAccessUserManagement()
    // {
    //     $client = static::createClient();
    //     $entityManager = static::getContainer()->get('doctrine')->getManager();
    ...
    //     // Supprime l'utilisateur admin existant si présent
    //     $existingAdmin = $entityManager->getRepository(User::class)->findOneBy(['email' => 'admin@test.com']);
    //     if ($existingAdmin) {
    //         $entityManager->remove($existingAdmin);
    //         $entityManager->flush();
    //     }
    //     // Création d'un utilisateur admin pour le test
    //     $admin = new User();
    //     $admin->setEmail('admin@test.com');
    //     $admin->setUsername('admin');
    //     $admin->setPassword($passwordHasher->hashPassword($admin, 'adminpass'));
    ...
    //     // Connexion en tant qu'admin et accès à la page de gestion des utilisateurs
    //     $client->loginUser($admin);
    //     $client->request('GET', '/users');
    //     $this->assertResponseIsSuccessful();
    // }

    // // Vérifie qu'un utilisateur simple ne peut pas accéder à la gestion des utilisateurs
    // public function testUserCannotAccessUserManagement()
    // {
    //     $client = static::createClient();
    //     $entityManager = static::getContainer()->get('doctrine')->getManager();
    ...
    //     // Supprime l'utilisateur user existant si présent
    //     $existingUser = $entityManager->getRepository(User::class)->findOneBy(['email' => 'user@test.com']);
    //     if ($existingUser) {
    //         $entityManager->remove($existingUser);
    //         $entityManager->flush();
    //     }
    //     // Création d'un utilisateur simple pour le test
    //     $user = new User();
    //     $user->setEmail('user@test.com');
    //     $user->setUsername('user');
    //     $user->setPassword($passwordHasher->hashPassword($user, 'userpass'));
